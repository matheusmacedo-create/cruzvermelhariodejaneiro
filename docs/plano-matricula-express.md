...
> **Nota de 18/09/2026.** A definição do produto passou a ser `docs/briefing-matricula-cursos-presenciais.md`.
> Duas decisões deste plano mudaram lá: (1) a página do aluno fica **dentro do domínio**, em
> `cruzvermelhariodejaneiro.org/matricula-cursos-presenciais/`, sem subdomínio; o backend reaproveitado
