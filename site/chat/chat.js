...
(function () {
  ...
  var RESPOSTAS = [
    ...
    { assuntos: ["doacoes"], rotulo: "Como doar? É seguro?", p: "Como doar para a Cruz Vermelha Brasileira Rio de Janeiro? A doação é segura?", r: "Você doa pela página de doação da Cruz Vermelha Brasileira Rio de Janeiro: escolhe o valor e conclui o pagamento por PIX ou cartão no ambiente seguro de doação da instituição. Por enquanto a doação é avulsa; a opção mensal está prevista na mesma página. A doação fica na filial do Estado do Rio de Janeiro e apoia formação de voluntários, capacitação em primeiros socorros, ações comunitárias, comunicação e estrutura operacional; CNPJ, endereço e e-mail estão publicados no site para conferência. Quem doa online recebe, como agradecimento, acesso futuro a cursos gravados gratuitos. Prefere doar roupas e cobertores? Veja a Campanha do Agasalho." },
  ...
  function proximoPasso() {
    ...
    // para por aqui, e quem para não precisou abrir chamado nem esperar três dias úteis.
